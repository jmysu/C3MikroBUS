 ...
 */
int MarioOver_note[] = {                                                 
  NOTE_C4, 0, 0, NOTE_G3, 0, NOTE_E3, NOTE_A3, NOTE_B3, NOTE_A3, NOTE_GS3, NOTE_AS3, 
  NOTE_GS3,NOTE_G3, NOTE_F3, NOTE_G3
};
int MarioOver_duration[] = {                                           
  4, 8, 8, 8, 4, 4, 6, 6, 6, 6, 6, 
  6, 8, 8, 4
};
int Pacman_note[] = {
  // Pacman
...
int CrazyFrog_note[] = {
  ...
  0,NOTE_D4,NOTE_D4, 0,NOTE_D4,NOTE_D4
};
